            ...
            if(len(z.get())) < 5:
                ...
                if s.get().isdigit():
                    ...
                    if cas is None:
                        ...
                        insert()
#label and input
        Label(self,text="School Library System",font=("Algerian",35,'bold'),fg="white",bg="black").place(x=100,y=80)
        ...
        Label( text="Username",fg='white', font=("Arial", 13, "bold"), bg="black").place(x=100, y=260)
        Label( text="Name",fg='white', font=("Arial", 13, "bold"), bg="black").place(x=100, y=300)
        Label( text="Password",fg='white', font=("Arial", 13, "bold"), bg="black").place(x=100, y=340)
